...
insert  into `temp_users`(`id`,`email`,`key`,`password`) values (1,'lucaslaermans@msn.com','a1510cb7d8e774f192107a363da9830d','cc03e747a6afbbcbf8be7668acfebee5'),(2,'lucaslaermans@msn.com','f8e98c282d694bf685e39bfc905419c1','cc03e747a6afbbcbf8be7668acfebee5'),(3,'mitch.dries@gmail.com','9f0bee8d3870ce5bbe7d62a289402705','098f6bcd4621d373cade4e832627b4f6');
...
insert  into `user_internships`(`id`,`user_id`,`company_name`,`location`,`latitude`,`longitude`,`description`) values (0,1,'Test','Niemandsland',5.311006,51.230419,'Apenkwekerij gevestigd in Niemandsland');
